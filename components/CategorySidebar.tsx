          ...
          <ul className="space-y-2">
            ...
            <li>
              ...
              >
                <svg
                  aria-hidden="true"
                  className="flex-shrink-0 w-6 h-6 text-secondary hover:text-white transition duration-75"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                  xmlns="http://www.w3.org/2000/svg"
                >
              ...
              <ul id="dropdown-example" className="hidden py-2 space-y-2">
                ...
                <li>
                  <a
                    href="#"
                    className="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-gray-600 hover:text-white dark:hover:bg-gray-700"
                  >
                    Billing
                  </a>
                </li>
            ...
            <li>
              <a
                href="#"
                className="flex items-center p-2 text-base font-normal text-gray-600 hover:text-white rounded-[2px] hover:bg-secondary"
              >
                <svg
                  aria-hidden="true"
                  className="w-6 h-6 text-secondary hover:text-white transition duration-75  group-hover:text-white "
